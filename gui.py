...
reception_gui_prompts=Label(reception_gui,text="Enter text")    #input prompts
...
reception_gui_button=Button(reception_gui,text="Show",command=photo_show,height=3,width=10)
